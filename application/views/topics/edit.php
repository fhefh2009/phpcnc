...
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-edit" action="" method="post">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="标题" value="<?php echo set_value('title', $topic['title']); ?>"
                           autofocus>
                    <textarea name="content" class="form-control" placeholder="正文（支持Markdown）" rows="18" data-provide="markdown"><?php echo set_value('content', $topic['content']); ?></textarea>
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo $topic['subject_id']['name']; ?></h3>
            </div>
            <div class="panel-body">
                <?php echo $topic['subject_id']['description']; ?>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
