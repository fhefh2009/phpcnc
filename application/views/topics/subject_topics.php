...
<div class="row">
    <div class="col-md-8">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a class="btn btn-default pull-right" href="topic/create/1" role="button">新的话题</a>


                <h3 class="panel-title">
                    <ol class="breadcrumb" style="margin: 0">
                        <li><a href="">PHPCNC</a></li>
                        <li class="active"><?php echo $subject['name']; ?></li>
                    </ol>
                </h3>
            </div>
            <ul class="list-group">
            ...
            <?php if($next_page || $pre_page){ ?>
                <div class="panel-footer">
                    <ul class="pager">
                        <?php if($next_page){ ?>
                            <li class="pull-right"><a href="topics/<?php echo $subject['id']; ?>/page/<?php echo $next_page; ?>">向右走</a></li>
                        <?php } ?>
                        <?php if($pre_page){ ?>
                            <li class="pull-right"><a href="topics/<?php echo $subject['id']; ?>/page/<?php echo $pre_page; ?>">向左走</a></li>
                        <?php } ?>
                    </ul>
                </div>
            <?php } ?>
    ...
    <div class="col-md-4">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">热门话题 &nbsp;•&nbsp; <?php echo $subject['name'] ?></h3>
            </div>
            <ul class="list-group">
