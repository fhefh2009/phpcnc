...
<style type="text/css">
    ...
    .form-forgotten .form-control:focus {
        z-index: 2;
    }
    .form-forgotten input[name="email"] {
        margin-bottom: -1px;
        border-bottom-left-radius: 0;
        border-bottom-right-radius: 0;
    }
    .form-forgotten input[name="captcha"] {
        margin-bottom: 10px;
...
<?php require dirname(__FILE__) . '/../content_start.php'; ?>
    <form class="form-forgotten" action="" method="post">
        <?php if($send_email === 'ok'){ ?>
        ...
        <input type="email" class="form-control" name="email" value="<?php echo set_value('email'); ?>" placeholder="邮箱"
               autofocus>
        ...
        <button class="btn btn-lg btn-default btn-block email" style="margin: 0px;" type="submit">发送邮件</button>
    </form>
